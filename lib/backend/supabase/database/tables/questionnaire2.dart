...
class Questionnaire2Table extends SupabaseTable<Questionnaire2Row> {
  @override
  String get tableName => 'questionnaire2';

  @override
  Questionnaire2Row createRow(Map<String, dynamic> data) =>
      Questionnaire2Row(data);
}

class Questionnaire2Row extends SupabaseDataRow {
  Questionnaire2Row(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => Questionnaire2Table();
