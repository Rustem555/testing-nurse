            ...
            child: Column(
              ...
              children: [
                ...
                Autocomplete<String>(
                  ...
                  optionsViewBuilder: (context, onSelected, options) {
                    return AutocompleteOptionsList(
                      textFieldKey: _model.newPasswordKey,
                      textController: _model.newPasswordTextController!,
                  ...
                  onSelected: (String selection) {
                    safeSetState(
                        () => _model.newPasswordSelectedOption = selection);
                    FocusScope.of(context).unfocus();
                  },
                  fieldViewBuilder: (
                    context,
                    ...
                    return TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Введите адрес э/почты',
                        labelStyle:
                ...
                Padding(
                  ...
                  child: Semantics(
                    label: 'Нажмите, чтобы сбросить пароль',
                    child: InkWell(
                      ...
                      onTap: () async {
                        if (_model.newPasswordTextController.text.isEmpty) {
                        ...
                        await authManager.resetPassword(
                          email: _model.newPasswordTextController.text,
                          context: context,
                        );
                        await showDialog(
                          context: context,
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              title: Text(
                                  'Если вы указали зарегистрированный э/адрес, на него придет ссылка, по которой вы можете поменять пароль'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
