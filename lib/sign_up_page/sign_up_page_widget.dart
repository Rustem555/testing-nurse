                  ...
                  children: [
                      ...
                      child: Autocomplete<String>(
                        ...
                        optionsViewBuilder: (context, onSelected, options) {
                          return AutocompleteOptionsList(
                            ...
                            textController: _model.nameTextController!,
                        ...
                        fieldViewBuilder: (
                          ...
                          return TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: 'Введите ваш псевдоним',
                      ...
                      child: Autocomplete<String>(
                        ...
                        fieldViewBuilder: (
                          ...
                          return TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: 'Пароль минимум 6 знаков',
                              labelStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.readexPro(
                              ...
                              hintText: 'Пароль минимум 6 знаков',
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    font: GoogleFonts.readexPro(
                    ...
                    Padding(
                      ...
                      child: Autocomplete<String>(
                        ...
                        optionsViewBuilder: (context, onSelected, options) {
                          return AutocompleteOptionsList(
                            textFieldKey: _model.passwordConfirmKey,
                            textController:
                        ...
                        onSelected: (String selection) {
                          safeSetState(() =>
                              _model.passwordConfirmSelectedOption = selection);
                          FocusScope.of(context).unfocus();
                        },
                        fieldViewBuilder: (
                          context,
                        ...
                        child: Theme(
                          ...
                          child: CheckboxListTile(
                            ...
                            onChanged: (newValue) async {
                              ...
                              if (newValue!) {
                                context.pushNamed(
                                    LicenceAgreementWidget.routeName);
                              }
                            },
                            title: Text(
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: (_model.checkboxListTileValue == false)
                            ? null
                            : () async {
                                ...
                                context.pushNamedAuth(
                                    CourseSelectionWidget.routeName,
                                    context.mounted);
                              },
                        text: 'Регистрация',
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Semantics(
                            label:
                                'перейдите на страницу входя если аккаунт уже есть',
                            child: FFButtonWidget(
                              onPressed: () async {
