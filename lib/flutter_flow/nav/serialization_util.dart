    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case QuestionnaireDemoRow:
            return QuestionnaireDemoRow(data);
          case QuestionnaireRow:
            return QuestionnaireRow(data);
          case Questionnaire2Row:
            return Questionnaire2Row(data);
          case UsersRow:
            return UsersRow(data);
          case GlobalRow:
            return GlobalRow(data);
          case OrdersRow:
